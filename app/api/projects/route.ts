...
export async function POST(req: NextRequest) {
  try {
    ...
    const validatedData: any = projectSchema.parse(body);
    console.log("API: Data validated successfully");

    // Conversion explicite de userId en ObjectId si besoin
    if (validatedData.userId && typeof validatedData.userId === "string") {
